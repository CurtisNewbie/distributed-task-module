...
CREATE TABLE task (
    ...
    last_run_start_time TIMESTAMP NOT NULL COMMENT "the last time this task was executed",
    last_run_end_time TIMESTAMP NOT NULL COMMENT "the last time this task was finished",
    last_run_by VARCHAR(255) NOT NULL COMMENT "app that previously ran this task",
